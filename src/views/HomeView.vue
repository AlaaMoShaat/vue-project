          ...
          <div class="card-item" v-bind:class="{ '-active': isCardFlipped }">
            <div class="card-item__side -front">
              ...
              <div class="card-item__cover">
                <img v-bind:src="selectedBG" class="card-item__bg" />
              </div>
...
export default {
  ...
  created() {
    this.selectedBG = this.reandomPhoto()
  },
  mounted() {
  ...
  methods: {
    reandomPhoto() {
      return `https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/${this.currentCardBackground}.jpeg`
    },
    flipCard(status) {
